...
const clientNav: Array<{ href: string; label: string; subtitle: string; icon: LucideIcon }> = [
  ...
  { href: "/tools/builtin-skills", label: "Built-in Skills", subtitle: "Packaged runtime handlers", icon: Puzzle },
  ...
  { href: "/tools/sandbox", label: "Sandbox", subtitle: "Policies & isolation", icon: Globe },
