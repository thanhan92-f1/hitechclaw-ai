// ============================================================
// @hitechclaw/core — Agent Engine
// ============================================================
// Agent
export { AgentHierarchy } from './agent/agent-hierarchy.js';
export { Agent } from './agent/agent.js';
export { ApprovalManager } from './agent/approval-manager.js';
export { CoordinatorAgent, buildWorkerToolRegistry, createInheritingAgentFactory, isCoordinatorModeEnabled } from './agent/coordinator.js';
export { EventBus } from './agent/event-bus.js';
export { MultiAgentOrchestrator } from './agent/multi-agent.js';
export { TaskManager, isTerminalTaskStatus } from './agent/task-manager.js';
...
// Tools
export { BUILT_IN_AGENT_DEFINITIONS, SPAWN_AGENT_TOOL_NAME, buildSpawnAgentHandler, buildSpawnAgentToolDefinition, wrapSpawnResult } from './tools/agent-spawn-tool.js';
