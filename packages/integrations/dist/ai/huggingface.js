...
async function hfInference(model, token, body) {
...
async function hfHubGet(path, token, params = {}) {
    ...
    actions: [
        {
            ...
            execute: async (args, ctx) => {
                ...
                try {
                    const payload = { inputs: args.inputs };
                    if (args.parameters)
        ...
        },
        {
            ...
            execute: async (args, ctx) => {
                ...
                if (!token)
                    return { success: false, error: 'HuggingFace token not configured' };
                try {
                    const params = { sort: args.sort, limit: String(args.limit) };
                    if (args.search)
