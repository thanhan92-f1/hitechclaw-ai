  ...
  actions: [
    {
      name: 'search',
      description:
        'Search the web using Tavily — optimized for AI agents with clean extracted content',
      parameters: z.object({
      ...
      execute: async (args, ctx) => {
        const params = args as z.infer<typeof tavilySearchIntegration.actions[0]['parameters']>;
