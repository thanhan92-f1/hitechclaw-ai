...
function storeFile(name, type, data) {
...
function buildBarChartSvg(labels, datasets, title) {
...
function buildLineChartSvg(labels, datasets, title) {
...
// ─── Excel builder ────────────────────────────────────────
function buildXlsx(data, headers, sheetName = 'Sheet1', title) {
...
Generate realistic, meaningful data. Include at least 5-15 rows. Use numbers where appropriate.`;
                ...
                const parsed = extractJsonBlock(aiResp);
