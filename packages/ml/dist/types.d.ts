...
export type FeatureTransform = {
    ...
    type: 'encode';
    method: 'one-hot' | 'label' | 'target' | 'ordinal';
} | {
    type: 'impute';
    ...
    type: 'bin';
    bins: number;
    method: 'equal-width' | 'equal-frequency' | 'kmeans';
} | {
    type: 'log';
} | {
    type: 'polynomial';
...
export type TaskType = 'classification' | 'regression' | 'clustering' | 'anomaly-detection' | 'time-series' | 'recommendation' | 'nlp-classification' | 'nlp-generation';
export type AlgorithmFamily = 'linear' | 'tree' | 'ensemble' | 'svm' | 'knn' | 'naive-bayes' | 'neural-network' | 'clustering' | 'dimensionality-reduction';
