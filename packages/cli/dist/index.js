...
switch (command) {
    case 'plugin': {
        switch (subcommand) {
            case 'create':
                if (!args[2]) {
                    console.error('Usage: hitechclaw plugin create <name>');
                    process.exit(1);
                }
    ...
    case 'docs': {
        ...
        switch (subcommand) {
            ...
            case 'search':
                if (!args[2]) {
                    console.error('Usage: hitechclaw docs search <query>');
                    process.exit(1);
                }
            ...
            case 'add':
                if (!args[2] || !args[3]) {
                    console.error('Usage: hitechclaw docs add <path> <title> [--tags t1,t2]');
                    process.exit(1);
                }
